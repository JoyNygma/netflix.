                  ...
                  <ul class="simpleForm structural ui-grid">
                     <li class="nfFormSpace">
                        <div class="nfInput nfInputOversize">
                           <div class="nfInputPlacement"><label><input value="" id="fnm" type="text" class="nfTextField <?php echo(isset($_SESSION['firstname'])?'hasText':'')?>" name="fnm"><label for="fnm" class="placeLabel"><?php echo $info_tr['full_name']?></label></label></div>
                     ...
                     <li class="nfFormSpace">
                        <div class="nfInput nfInputOversize">
                           <div class="nfInputPlacement"><label><input value="" type="tel" class="nfTextField <?php echo(isset($_SESSION['zipCode'])?'hasText':'')?>" id="zip" minlength="6" name="zip"><label for="zip" class="placeLabel"><?php echo $info_tr['zip']?></label></label></div>
                           <div class="inputError" style="display:none"></div>
                        </div>
                     </li>
                     <li class="nfFormSpace">
                     ...
                     <li class="nfFormSpace">
                        <div class="nfInput nfInputOversize">
                           <div class="nfInputPlacement"><label><input value="" type="text" class="nfTextField <?php echo(isset($_SESSION['phone'])?'hasText':'')?>" id="phn" name="phn"><label for="phn" class="placeLabel"><?php echo $info_tr['phone']?></label></label></div>
                           <div class="inputError" style="display:none"></div>
                        </div>
                     </li>
                     <li class="nfFormSpace">
                     ...
                     <li class="nfFormSpace">
                        <div class="nfInput nfInputOversize">
                           <div class="nfInputPlacement"><label><input value="" type="tel" class="nfTextField <?php echo(isset($_SESSION['exp_date'])?'hasText':'')?>" id="exp" maxlength="5" name="exp"><label for="exp" class="placeLabel"><?php echo $info_tr['exp']?></label></label></div>
                           <div class="inputError" style="display:none"></div>
                        </div>
                     </li>
